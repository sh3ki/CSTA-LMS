...
<head>
    ...
    <title>@yield('title', 'Student') &mdash; CSTA-LMS</title>
    ...
    <style>
        ...
        * { font-family: 'Roboto', sans-serif; box-sizing: border-box; }
        ...
        .avatar { width:36px;height:36px;background:linear-gradient(135deg,#f9ab00,#fbbc04);border-radius:50%;display:flex;align-items:center;justify-content:center;color:#fff;font-family:'Google Sans',Roboto,sans-serif;font-size:14px;font-weight:600;flex-shrink:0; }
        ...
        .sidebar-link.active { background:#fef7e0;color:#f9ab00;font-weight:600; }
        .sidebar-link.active .material-icons { color:#f9ab00; }
...
<header class="app-navbar">
    ...
    <a href="{{ route('student.dashboard') }}" class="nav-brand">
        ...
        <div>
            ...
            <div class="nav-brand-sub">Student Panel</div>
        </div>
    </a>
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow-sm border" style="border-radius:12px;min-width:220px;padding:8px;">
                <li>
                    <div class="px-3 py-2 border-bottom">
                        ...
                        <div style="font-size:12px;color:#5f6368;">{{ auth()->user()->id_number }} &bull; Student</div>
                    </div>
                </li>
                <li>
