...
<aside class="app-sidebar" id="appSidebar">
    ...
    <a href="{{ route('teacher.analytics.index') }}" class="sidebar-link {{ request()->routeIs('teacher.analytics*') ? 'active' : '' }}">
    ...
    <a href="{{ route('teacher.announcements.index') }}" class="sidebar-link {{ request()->routeIs('teacher.announcements*') ? 'active' : '' }}">
