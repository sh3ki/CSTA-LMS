    ...
    <div class="d-flex align-items-center gap-3">
        ...
        <div>
            <h1 class="page-title" style="margin-bottom:2px;">
                <span class="material-icons align-middle me-2" style="color:#800020;">person</span>
                {{ $student->full_name }}
            </h1>
            <p class="page-subtitle" style="margin:0;">{{ $student->id_number }} &middot; Individual Student Analytics</p>
        </div>
    </div>
    <a href="{{ route('admin.analytics.index') }}#student" class="btn btn-outline-secondary rounded-pill px-4">
        <span class="material-icons align-middle me-1" style="font-size:16px;">group</span> All Students
    </a>
</div>
