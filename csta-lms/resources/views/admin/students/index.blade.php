            ...
            <tbody>
                @forelse ($students as $index => $student)
                    <tr>
                        ...
                        <td><code style="background:#f1f3f4;padding:3px 8px;border-radius:6px;font-size:13px;color:#202124;">{{ $student->id_number }}</code></td>
            ...
            <div class="modal-header">
                <div class="d-flex align-items-center gap-2">
                    <div style="width:36px;height:36px;background:#e6f4ea;border-radius:10px;display:flex;align-items:center;justify-content:center;">
                        <span class="material-icons" style="color:#34a853;font-size:20px;">person_add</span>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius:16px;border:none;box-shadow:0 8px 32px rgba(0,0,0,.15);">
            <div class="modal-header">
                <div class="d-flex align-items-center gap-2">
                    <div style="width:36px;height:36px;background:#e6f4ea;border-radius:10px;display:flex;align-items:center;justify-content:center;">
                        <span class="material-icons" style="color:#34a853;font-size:20px;">edit</span>
                    </div>
...
<script>
    ...
    document.getElementById('deleteModal').addEventListener('show.bs.modal', event => {
        ...
        document.getElementById('deleteStudentName').textContent =
            `This will permanently delete the student account of "${btn.dataset.name}". This action cannot be undone.`;
    });
